          ...
          children: [
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: Text('ashraf15-3950@diu.edu.bd'),
              ),
            ),
            Card(
              margin: EdgeInsets.symmetric(vertical: 8.0, horizontal: 16.0),
            ...
            Wrap(
              ...
              runSpacing: 8.0,
              children: [
                Chip(label: Text('Portfolio App')),
                Chip(label: Text('Calculator')),
                Chip(label: Text('Quiz App')),
                Chip(label: Text('Weather App')),// Add more skills as needed
              ],
            ),
